...
const submit = () => {
    form.post(route('admin.box-configs.store'))
}
</script>

<template>
    <Head title="Nueva configuración de caja" />

    <AdminLayout>
        <div class="row page-titles mx-0">
            <div class="col-sm-6 p-md-0">
                <div class="welcome-text">
                    <h4>Nueva configuración de caja</h4>
                    <span>Definir tallos por caja según presentación y tipo</span>
                </div>
            </div>
        </div>
