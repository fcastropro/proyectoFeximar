...
/**
 * ISO 3166-1 country catalog for FEXIMAR seeders.
 * Each row: name, iso2, iso3, phone_code
 */
return [
    ...
    ['British Virgin Islands', 'VG', 'VGB', '1'],
    ['Brunei', 'BN', 'BRN', '673'],
    ['Bulgaria', 'BG', 'BGR', '359'],
