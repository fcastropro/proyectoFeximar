...
const submit = () => form.post(route('admin.varieties.store'))
</script>

<template>
    <Head title="Nueva variedad" />
    <AdminLayout>
        <div class="row page-titles mx-0">
            <div class="col-sm-6 p-md-0">
                <div class="welcome-text">
                    <h4>Nueva variedad</h4>
                    <span>Registrar variedad para el catálogo de productos</span>
                </div>
            </div>
        </div>
